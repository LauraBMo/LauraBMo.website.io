...
<!-- The policy is already written, from the app's actual data handling — what is
     ...
     built, the policy moves here, at /softreminder/privacy, and the Play listing URL
     changes with it. It does not need rewriting, only moving.

     Do not link laurabmo.xyz anywhere. That domain is not ours: it was not renewed
     after 2023 and a third party re-registered it on 2026-06-21. -->
